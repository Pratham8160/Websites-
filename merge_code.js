...
function LiveMatchPage({ matches, teams }) {
  ...
  const currentRuns = liveMatch.currentRuns || 0;
  const currentWickets = liveMatch.currentWickets || 0;
  const ballsBowled = liveMatch.ballsBowled || 0;
  const target = liveMatch.target || null;
  const innings = liveMatch.innings || 1;
  const recentBalls = liveMatch.recentBalls || [];
  const striker = liveMatch.striker || null;
  const nonStriker = liveMatch.nonStriker || null;
  const bowler = liveMatch.bowler || null;
  const commentary = liveMatch.commentary || [];
  const oversStr = formatOvers(ballsBowled);
  const crr = computeCRR(currentRuns, ballsBowled);
  return /*#__PURE__*/React.createElement("div", {
    className: "max-w-xl mx-auto px-5 py-8"
  }, /*#__PURE__*/React.createElement("div", {
    className: "bg-navy-dark rounded-xl p-6 text-white text-center shadow-lg relative overflow-hidden mb-6"
  }, /*#__PURE__*/React.createElement("span", {
    className: "bg-white-10 text-orange font-mono text-xs uppercase tracking-widest px-3 py-1 rounded-full mb-4 inline-block"
  }, "🔴 Innings " + innings), /*#__PURE__*/React.createElement("h2", {
    className: "font-display text-2xl uppercase mb-2"
  }, (t1?.name || "TBD") + " vs " + (t2?.name || "TBD")), /*#__PURE__*/React.createElement("div", {
    className: "font-display text-5xl tracking-wide my-4 text-orange"
  }, currentRuns + "/" + currentWickets), /*#__PURE__*/React.createElement("div", {
    className: "text-white-60 font-mono text-sm"
  }, oversStr + " Overs · CRR: " + crr), target && /*#__PURE__*/React.createElement("div", {
    className: "mt-4 text-yellow-400 font-semibold text-sm border-t border-white-10 pt-3"
  }, "Target: " + target + " · Need " + Math.max(0, target - currentRuns) + " from " + (120 - ballsBowled) + " balls")), /*#__PURE__*/React.createElement("div", {
    className: "bg-blush rounded-xl p-5 border border-navy-dark-05 mb-6"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "font-mono text-xs text-navy-dark-50 uppercase mb-3 border-b border-navy-dark-08 pb-1"
  }, "Batsmen"), /*#__PURE__*/React.createElement("div", {
    className: "space-y-2 mb-4"
  }, striker && /*#__PURE__*/React.createElement("div", {
    className: "flex justify-between items-center text-sm"
  }, /*#__PURE__*/React.createElement("span", {
    className: "font-semibold text-navy-dark"
  }, striker.name + " *"), /*#__PURE__*/React.createElement("span", {
    className: "font-mono text-navy-dark-80"
  }, striker.runs + " (" + striker.balls + ")")), nonStriker && /*#__PURE__*/React.createElement("div", {
    className: "flex justify-between items-center text-sm"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-navy-dark-70"
  }, nonStriker.name), /*#__PURE__*/React.createElement("span", {
    className: "font-mono text-navy-dark-70"
  }, nonStriker.runs + " (" + nonStriker.balls + ")"))), bowler && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h3", {
    className: "font-mono text-xs text-navy-dark-50 uppercase mb-3 border-b border-navy-dark-08 pb-1"
  }, "Bowler"), /*#__PURE__*/React.createElement("div", {
    className: "flex justify-between items-center text-sm"
  }, /*#__PURE__*/React.createElement("span", {
    className: "font-semibold text-navy-dark"
  }, bowler.name), /*#__PURE__*/React.createElement("span", {
    className: "font-mono text-navy-dark-80"
  }, bowler.wickets + "-" + bowler.runs + " (" + formatOvers(bowler.balls) + ")")))), /*#__PURE__*/React.createElement("div", {
    className: "bg-blush rounded-xl p-5 border border-navy-dark-05 mb-6"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "font-mono text-xs text-navy-dark-50 uppercase mb-3"
  }, "This Over"), /*#__PURE__*/React.createElement("div", {
    className: "flex gap-2 flex-wrap"
  }, recentBalls.length === 0 ? /*#__PURE__*/React.createElement("span", {
    className: "text-navy-dark-30 text-xs font-mono"
  }, "No balls bowled yet.") : recentBalls.map((ball, idx) => {
    let ballCls = "bg-navy-dark-10 text-navy-dark";
    if (ball === "W") ballCls = "bg-red-500 text-white font-bold";else if (ball === "4" || ball === "4s") ballCls = "bg-orange text-white font-bold";else if (ball === "6") ballCls = "bg-green-600 text-white font-bold";else if (ball === "Wd" || ball === "Nb") ballCls = "bg-yellow-500 text-navy-dark";
    return /*#__PURE__*/React.createElement("span", {
      key: idx,
      className: "w-7 h-7 rounded-full flex items-center justify-center text-xs font-mono " + ballCls
    }, ball);
  }))), /*#__PURE__*/React.createElement("div", {
    className: "bg-blush rounded-xl p-5 border border-navy-dark-05"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "font-mono text-xs text-navy-dark-50 uppercase mb-3 border-b border-navy-dark-08 pb-1"
  }, "Commentary"), /*#__PURE__*/React.createElement("div", {
    className: "space-y-3 max-h-60 overflow-y-auto pr-2"
  }, commentary.length === 0 ? /*#__PURE__*/React.createElement("div", {
    className: "text-navy-dark-30 text-xs font-mono"
  }, "Waiting for commentary...") : [...commentary].reverse().map((c, idx) => /*#__PURE__*/React.createElement("div", {
    key: idx,
    className: "text-xs border-b border-navy-dark-05 pb-2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "font-mono font-bold text-orange mr-2"
  }, c.ball), /*#__PURE__*/React.createElement("span", {
    className: "text-navy-dark-80 font-body"
  }, c.text))))));
}
...
function AdminScorerPage({ matches, teams, seasons, selectedSeasonId, sponsors, settings, isFirestoreEnabled, db, onPersist, onUpdateSettings, onAddSeason, onToggleActiveSeason, onAddSponsor, onDeleteSponsor }) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    /*#__PURE__*/React.createElement("div", {
      ...
      /*#__PURE__*/React.createElement("h3", { className: "font-display text-navy-dark text-lg uppercase" }, "Start Live Scoring"),
      /*#__PURE__*/React.createElement("div", { className: "form-group" }, 
        /*#__PURE__*/React.createElement("label", { className: "block text-xs font-mono uppercase text-navy-dark-50 mb-1" }, "Select Fixture"),
        /*#__PURE__*/React.createElement("select", {
          className: inputCls(),
          ...
          onChange: e => {
            ...
            if (m) {
              setBattingTeamId(m.team1Id);
              setVenue(m.venue || "");
            }
          }
        }, 
          /*#__PURE__*/React.createElement("option", { value: "" }, "Select upcoming match..."),
          upcoming.map(m => {
            const tm1 = teams.find(t => t.id === m.team1Id);
            const tm2 = teams.find(t => t.id === m.team2Id);
            return /*#__PURE__*/React.createElement("option", { key: m.id, value: m.id }, tm1?.name + " vs " + tm2?.name);
          })
        )
      ),
      selectedMatch && /*#__PURE__*/React.createElement(React.Fragment, null,
        /*#__PURE__*/React.createElement("div", { className: "grid grid-cols-2 gap-3" }, 
          /*#__PURE__*/React.createElement("div", { className: "form-group" }, 
            /*#__PURE__*/React.createElement("label", { className: "block text-xs font-mono uppercase text-navy-dark-50 mb-1" }, "Batting First"),
            /*#__PURE__*/React.createElement("select", {
              className: inputCls(),
              value: battingTeamId,
              onChange: e => setBattingTeamId(e.target.value)
            }, 
              /*#__PURE__*/React.createElement("option", { value: selectedMatch.team1Id }, selT1?.name),
              /*#__PURE__*/React.createElement("option", { value: selectedMatch.team2Id }, selT2?.name)
            )
          ),
          /*#__PURE__*/React.createElement("div", { className: "form-group" }, 
            /*#__PURE__*/React.createElement("label", { className: "block text-xs font-mono uppercase text-navy-dark-50 mb-1" }, "Venue"),
        ...
        /*#__PURE__*/React.createElement("button", {
          className: "w-full bg-orange text-white py-2.5 rounded-md font-mono text-sm uppercase tracking-wide",
          onClick: handleStartLive
        }, "🔴 Start Live Match")
      )
    ) :
    /*#__PURE__*/React.createElement("div", { className: "bg-blush rounded-xl p-5 border border-navy-dark-05 space-y-4" }, 
      /*#__PURE__*/React.createElement("div", { className: "bg-navy-dark rounded-xl p-4 text-white text-center" }, 
        /*#__PURE__*/React.createElement("div", { className: "font-display text-4xl text-orange" }, (liveMatch.currentRuns || 0) + "/" + (liveMatch.currentWickets || 0)),
        /*#__PURE__*/React.createElement("div", { className: "text-white-60 font-mono text-xs" }, formatOvers(liveMatch.ballsBowled || 0) + " Overs")
      ),
      /*#__PURE__*/React.createElement("div", { className: "grid grid-cols-5 gap-2" }, 
        ["0", "1", "2", "3", "4", "6", "W", "Wd", "Nb", "4s"].map(ball => 
          /*#__PURE__*/React.createElement("button", {
            key: ball,
            className: "bg-navy text-white font-mono font-bold py-2 rounded text-center hover:bg-orange transition-colors",
            onClick: () => handleBall(ball)
          }, ball)
        )
      ),
      /*#__PURE__*/React.createElement("div", { className: "form-group mt-3" }, 
        /*#__PURE__*/React.createElement("input", {
          className: inputCls(),
          placeholder: "Custom Commentary (Optional)",
      ...
      /*#__PURE__*/React.createElement("div", { className: "grid grid-cols-2 gap-3" }, 
        /*#__PURE__*/React.createElement("div", { className: "space-y-1" },
          /*#__PURE__*/React.createElement("label", { className: "block text-[10px] font-mono uppercase text-navy-dark-50" }, "Striker (Facing)"),
          /*#__PURE__*/React.createElement("input", {
            className: inputCls(),
            placeholder: "Striker name",
            value: bat1,
            onChange: e => setBat1(e.target.value),
            onBlur: () => handleUpdateStriker(bat1)
          })
        ),
        /*#__PURE__*/React.createElement("div", { className: "space-y-1" },
          /*#__PURE__*/React.createElement("label", { className: "block text-[10px] font-mono uppercase text-navy-dark-50" }, "Non-Striker"),
          /*#__PURE__*/React.createElement("input", {
            className: inputCls(),
            placeholder: "Non-Striker name",
            value: bat2,
            onChange: e => setBat2(e.target.value),
            onBlur: () => handleUpdateNonStriker(bat2)
          })
        )
      ),
      /*#__PURE__*/React.createElement("button", {
        className: "w-full bg-navy-dark-10 text-navy-dark hover:bg-navy-dark-20 font-mono text-xs py-1.5 rounded transition-colors uppercase tracking-wider",
        onClick: handleSwapStrikerNonStriker
      }, "🔄 Swap Striker & Non-Striker"),
      /*#__PURE__*/React.createElement("div", { className: "space-y-1" },
        /*#__PURE__*/React.createElement("label", { className: "block text-[10px] font-mono uppercase text-navy-dark-50" }, "Active Bowler"),
        /*#__PURE__*/React.createElement("input", {
          className: inputCls(),
          placeholder: "Bowler name",
          value: bwl,
          onChange: e => setBwl(e.target.value),
          onBlur: () => handleUpdateBowler(bwl)
        })
      ),
      /*#__PURE__*/React.createElement("button", {
        className: "w-full bg-red-600 text-white font-mono text-sm py-2 rounded-md uppercase tracking-wide",
      ...
      /*#__PURE__*/React.createElement("div", {
        ...
        /*#__PURE__*/React.createElement("div", { className: "form-group" }, 
          ...
          /*#__PURE__*/React.createElement("input", {
            ...
            placeholder: "e.g. Yuvakmandal Secundrabad - Garud Production"
          })
        ),
        /*#__PURE__*/React.createElement("div", { className: "form-group" }, 
...
function CricketSite() {
  ...
  const [settings, setSettings] = useState({ featuredMatchId: "", logoHeader: LOGO_SRC, logoFooter: FOOTER_LOGO_SRC, seasonLabel: SEASON_LABEL, tournamentName: TOURNAMENT_NAME, tagline: TOURNAMENT_TAGLINE });
  ...
  if (!loaded) {
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "text-navy-dark font-mono text-sm"
    }, "Loading…"));
  }
  ...
  }, "Powered By Yuvakmandal Secundrabad - Garud Production")))), showLogin && /*#__PURE__*/React.createElement(Modal, {
    title: "Owner login",
    onClose: () => {
      setShowLogin(false);
      setLoginError("");
